...
| `CallerMdcSnapshot` | The caller's MDC at wiring, own and trace keys excluded, restored around the emission only on another thread than the calling one (ADR-0011). |
