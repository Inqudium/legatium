...
(<module>/docs/GUIDE.md, plus any further guide documents a module
configures below) so they stay close to the code they describe. So that the site renders them instead of linking to GitHub,
